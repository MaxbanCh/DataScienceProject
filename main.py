...
def main():
    ...
    input_file = 'data/raw/Films à la télévision (données statistiques).xlsx'
    output_file = 'NombreDiffusionFilmsIneditsALaTelevisionPremierePartieSoiree.csv'
    sheet_name = 'FilmsPTInédits'
    first_row = 8
    last_row = 120
