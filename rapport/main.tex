...
En appliquant une régression sur le nombre d'évocation des partis de gauche et d'extrême droite, on constate, un forte corrélation entre celle-ci avec $R^2 = $ et un coefficient $\beta_1 = $
...
On constate que les thèmes de Police/Justice ont considérablement augmenté sur la plupart des chaines, mise à part BFM TV qui était déjà au dessus des autres (régression sur chacune des chaine). Ces sujets étant en général associés aux faits divers, on peut 
